                                                  ...
                                                  const r1cs_auxiliary_input<FieldT> &auxiliary_input) const
{
    ...
    for (size_t c = 0; c < constraints.size(); ++c)
    {
        ...
        // printf("terms for a:\n");constraints[c].a.print_with_assignment(full_variable_assignment);
        // printf("terms for b:\n");constraints[c].b.print_with_assignment(full_variable_assignment);
        // printf("terms for c:\n");constraints[c].c.print_with_assignment(full_variable_assignment);
        if (!(ares*bres == cres))
        {
#ifdef DEBUG
    ...
    // std::cout<<full_variable_assignment.begin() - full_variable_assignment.end() <<std::endl;
    return true;
}
